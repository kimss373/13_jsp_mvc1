...
<body>
	<div align="center" style="padding-top: 100px">
		<form action="bWritePro.jsp" name="f" method="post" onsubmit="return checkFormValidation()">
							...
							<table class="table table-hover" style="width: 700px;">
								...
								<tr align="center">
									<td colspan=2>
										...
										<input type="button" class="btn btn-primary btn-sm" onclick="location.href='bList.jsp'" value="전체게시글보기">
									</td>
								</tr>
							</table>
						</div>
